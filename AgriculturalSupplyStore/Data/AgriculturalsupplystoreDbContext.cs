...
public partial class AgriculturalsupplystoreDbContext : DbContext
{
    public AgriculturalsupplystoreDbContext()
    {
    }

    public AgriculturalsupplystoreDbContext(DbContextOptions<AgriculturalsupplystoreDbContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<KieuMay> KieuMays { get; set; }
...
//        => optionsBuilder.UseSqlServer("Data Source=DUYKHOA;Initial Catalog=AgriculturalsupplystoreDB;Persist Security Info=True;User ID=sa;Password=123456;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.MaBoPhan).HasName("PK_Parts");
        ...
        modelBuilder.Entity<KieuMay>(entity =>
        {
            entity.HasKey(e => e.MaKieuMay).HasName("PK_Segments");
        ...
        {
            entity.HasKey(e => e.MaLoaiMay).HasName("PK_Types");
        ...
        {
            entity.HasKey(e => e.MaPhan).HasName("PK_Components");
